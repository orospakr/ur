...
namespace ur
{
  ...
  // class constructor
  Titlescreen::Titlescreen(std::string basedir, SDL_Renderer *renderer, Font *fonts, Audio *audio)
  {
    scrollerText =
  ...
  Sint64
  Titlescreen::run(UR_INPUT keystate, SDL_Renderer *renderer)
  {
    Sint64 result = 1;
    // draw the screen
    ...
    SDL_QueryTexture(titleGraphic, NULL, NULL, &titleGraphicWidth, &titleGraphicHeight);
