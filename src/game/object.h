...
class Object {
  public:
     ...
     * same name), and is used to determine which directory the data may be
     * loaded from, amongst other things)
     */
    ...
    /// collision detection method.  NOTE:  When objects collide, the object
    /// that 'affects' the action should be the one that makes the calls to the
