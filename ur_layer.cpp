...
// class constructor
ur_layer::ur_layer (std::string layerPath, UR_LAYER_ENUM position,
		    bool transparent, SDL_Surface * tileset,
		    SDL_PixelFormat * screenFormat, ur_object ** objPile)
{
  tilepile = tileset;
  objects = objPile;
  tilesAnimPos = 0;
 ...
 */
Sint64
ur_layer::loadLayerMap (std::string agmFilename, std::string apmFilename)
{
...
Sint64
ur_layer::drawToScreen (SDL_Surface * screen, SDL_Rect screenGeom)
{
...
SDL_Rect *
ur_layer::getTileSrcCoord (Sint64 number)
{
...
SDL_Rect *
ur_layer::getTileDestCoord (Sint64 x, Sint64 y)
{
  SDL_Rect *result = new SDL_Rect;
  result->h = TILE_HEIGHT;
  result->w = TILE_WIDTH;
